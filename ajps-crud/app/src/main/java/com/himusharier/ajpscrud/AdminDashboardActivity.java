...
import com.himusharier.ajpscrud.databinding.ActivityAdminDashboardBinding;
...
public class AdminDashboardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        } else if (id == R.id.nav_admin_journals) {
            Toast.makeText(this, "Manage Journals", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_admin_submissions) {
